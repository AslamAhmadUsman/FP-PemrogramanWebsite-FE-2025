  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto py-8 px-6">
        ...
        <div
          className="w-full border rounded-xl bg-white shadow-sm p-4 h-[calc(100vh-260px)] overflow-hidden"
          ...
          >
            {tiles.map((tile) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-full h-full rounded-md flex items-center justify-center font-semibold tracking-wide text-white shadow-inner transition-all duration-500 will-change-transform ${tile.flipped ? "bg-slate-900 animate-tile-flip" : tile.color} ${tile.justUnflipped ? "animate-tile-unflip" : ""}`}
                    style={{
